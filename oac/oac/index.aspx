<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="oac.index" %>
    ...
    <form runat="server">
        ...
        <div id="container">
            ...
            <section class="discover discover-best">
                <div class="container">
                    <p class="discover__description" style="color: white">
                        Orientation services in Windsor, Essex and Chatham-Kent.
                    </p>
                    <h1 class="discover__title places-tab" style="color: white">Find amazing activities.
                    </h1>
                </div>
            </section>
            <!-- End Title Overlay -->
                                        ...
                                        <div class="place-post">
                                            ...
                                            <div class="place-post__content">
                                                <h2 class="place-post__title">
                                                    ...
                                                    <asp:LinkButton ID="LinkButton2" PostBackUrl='<%# String.Format("~/orgpage.aspx?id={0}", Eval("OrgID")) %>' runat="server"><%#Eval("OrgName") %></asp:LinkButton>
                                                </h2>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="footer__widget text-widget">
                                    ...
                                    <p class="footer__widget-description">
                                        This website has been developed as part of a final year project by the School of Computer Science 2019, 
                            at the University of Windsor, under the supervision of <a href="http://kobti.myweb.cs.uwindsor.ca/">Dr. Kobti</a>. 
                                    </p>
                                </div>
