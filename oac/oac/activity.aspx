<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activity.aspx.cs" Inherits="oac.activity" %>
...
<body>
    <form runat="server">
        <!-- Data Sources -->
        <asp:SqlDataSource ID="SqlDataSourceOrgNames" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSourceCity" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSourceStreams" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSourceCategories" runat="server"></asp:SqlDataSource>
        ...
        <div id="container">
            ...
            <section class="add-listing">
                <div class="add-listing__title-box">
                    <div class="container">
                        <h1 class="add-listing__title">Add New Activity
                        </h1>
                    </div>
                </div>
                ...
                <form class="add-listing__form">
                    ...
                    <div class="container">
                            ...
                            <div class="add-listing__form-content">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <asp:DropDownList ID="OrgName" class="add-listing__input js-example-basic-multiple" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="ActivityTitle">
                                            Activity Title:
                                        </label>
                                        <asp:TextBox ID="ActivityTitle" class="add-listing__input" Placeholder="Activity" runat="server"></asp:TextBox>
                                        <asp:TextBox ID="ImagePG" runat="server" Visible="false"></asp:TextBox>
                                    </div>
                                </div>

                                <label class="add-listing__label" for="EventDesc">
                                    Description:
                                </label>
                                <asp:TextBox ID="ActivityDesc" class="add-listing__textarea" placeholder="Describe the activity" runat="server"></asp:TextBox>
                            </div>
                            ...
                            <div class="add-listing__form-content">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <asp:TextBox ID="Address" class="add-listing__input" placeholder="Enter your address" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:TextBox ID="PostalCode" class="add-listing__input" placeholder="Enter your postal code" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="add-listing__form-content">
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <label class="add-listing__label" for="HostName">
                                            Host Name:
                                        </label>
                                        <asp:TextBox ID="HostName" class="add-listing__input" placeholder="Individuals Name" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                        ...
                        <!-- Fourth Section -->
                        <div class="add-listing__form-box element-waypoint" id="hours-box">

                            <h2 class="add-listing__form-title">Hours:
                            </h2>

                            <div class="add-listing__form-content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="StartTime">
                                            Start Time:
                                        </label>
                                        <asp:TextBox ID="StartTime" class="add-listing__input" Placeholder="Format: '00:00 AM' - Include AM/PM" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="EndTime">
                                            EndTime:
                                        </label>
                                        <asp:TextBox ID="EndTime" class="add-listing__input" Placeholder="Format: '00:00 AM' - Include AM/PM" runat="server"></asp:TextBox>
                                    </div>
                                </div>

                                <label class="add-listing__label" for="Date">
                                    Date:
                                </label>
                                <asp:TextBox ID="Date" class="add-listing__input" placeholder="Date of activity" runat="server"></asp:TextBox>
                            </div>
                        ...
                        <div class="add-listing__form-box element-waypoint" id="categories-box">
                            ...
                            <h2 class="add-listing__form-title">Categories:
                            </h2>

                            <div class="add-listing__form-content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="StreamOne">
                                            Stream One:
                                        </label>
                                        <asp:DropDownList ID="StreamOne" class="add-listing__input js-example-basic-multiple" Placeholder="Stream One" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="StreamTwo">
                                            Stream Two:
                                        </label>
                                        <asp:DropDownList ID="StreamTwo" class="add-listing__input js-example-basic-multiple" Placeholder="Stream Two" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="CategoryOne">
                                            Category One:
                                        </label>
                                        <asp:DropDownList ID="CategoryOne" class="add-listing__input js-example-basic-multiple" Placeholder="Category One" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="CategoryTwo">
                                            Category Two:
                                        </label>
                                        <asp:DropDownList ID="CategoryTwo" class="add-listing__input js-example-basic-multiple" Placeholder="Category Two" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="TargetOne">
                                            Target One:
                                        </label>
                                        <asp:DropDownList ID="TargetOne" class="add-listing__input js-example-basic-multiple" Placeholder="Target One" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="add-listing__label" for="TargetTwo">
                                            Target Two:
                                        </label>
                                        <asp:DropDownList ID="TargetTwo" class="add-listing__input js-example-basic-multiple" Placeholder="Target Two" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
